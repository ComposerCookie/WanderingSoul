...
namespace Lost_Soul
{
    public class NewPartyOk : GUIButton
    {
        RenderWindow _screen;
        public NewPartyOk(RenderWindow rw, int id, int x, int y)
        {
            _screen = rw;
            ID = id;
            X = x;
        ...
        public void Picked()
        {
            ...
            if (g.CurrentSession.MainParty.MyParty.Count > 0)
            {
                Program.Data.MyPlayerDatas.Add(g.CurrentSession);
            }
            ...
            Program.SM.States[0].CurrentGUI = 1;
        }
