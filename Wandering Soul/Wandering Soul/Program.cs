...
namespace Lost_Soul
{
    static class Program
    {
        ...
        static void OnKeyPressed(object sender, KeyEventArgs e)
        {
            ...
            SM.States[SM.CurrentState].HandleKey(e.Code);
        ...
        static void OnMousePress(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                SM.States[SM.CurrentState].HandleMouse(e.Button);
            }
        ...
        static void OnMouseMove(object sender, MouseMoveEventArgs e)
        {
            ...
            SM.States[SM.CurrentState].HandleMouseMove();
        }
        ...
        static public MapGenerator Generator { get; set; }
        static public Data Data { get; set; }
        static public RenderWindow RW { get; set; }
        static public GUIButton UsingButton { get; set; }
        static public InGameLog Log { get; set; }
        static public int MouseState { get; set; }
