    ...
    class RightClickWalk : RightClickButton
    {
        ...
        public void Picked()
        {
            if (Mouse.IsButtonPressed(Mouse.Button.Left))
            {
                ...
                Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].TargetX = LocX - Program.MyMap.MinX;
                Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].TargetY = LocY - Program.MyMap.MinY;
