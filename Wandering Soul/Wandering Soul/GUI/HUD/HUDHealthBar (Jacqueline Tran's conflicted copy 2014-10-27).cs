    ...
    public class HUDHealthBar : GUIButton
    {
        ...
        public void Draw()
        {
            ...
            for (int p = 0; p < Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty.Count; p++)
            {
                ...
                s.TextureRect = new IntRect(0, 0, Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[p].CurrentHealth * 100  / Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[p].MaxHealth * (int)s.Texture.Size.X / 100, (int)s.Texture.Size.Y);
