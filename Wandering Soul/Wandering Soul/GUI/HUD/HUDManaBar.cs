    ...
    public class HUDManaBar : GUIButton
    {
        ...
        public void Draw()
        {
            ...
            for (int p = 0; p < Logic.CurrentParty.MainParty.MyParty.Count; p++)
            {
                ...
                s.TextureRect = new IntRect(0, 0, Logic.CurrentParty.MainParty.MyParty[p].CurrentMana * 100 / Logic.CurrentParty.MainParty.MyParty[p].MaxMana * (int)s.Texture.Size.X / 100, (int)s.Texture.Size.Y);
