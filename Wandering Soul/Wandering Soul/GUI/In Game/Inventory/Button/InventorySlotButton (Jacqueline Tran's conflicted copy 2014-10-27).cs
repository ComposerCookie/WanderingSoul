...
namespace Lost_Soul
{
    public class InventorySlotButton : GUIButton
    {
        ...
        public void Picked()
        {
            ...
            {
                if (SlotID < Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory.Count && Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID] != null)
                {
                    if (State == 0)
                    {
                        if (Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID] == null)
                        {
                            return;
                        }
                        State = 1;
                        ...
                        for (int r = 0; r < 4; r++)
                        {
                            for (int c = 0; c < 4; c++)
                            {
                                ...
                                if (x >= Program.State[1].GameGUI[1].X + (c * 38) + 6 && x <= Program.State[1].GameGUI[1].X + 38 * (c + 1) && y >= Program.State[1].GameGUI[1].Y + 26 + (r * 38) && y <= Program.State[1].GameGUI[1].Y + (r + 1) * 38 + 26)
                                {
                                    ...
                                    {
                                        Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[r * 4 + c] = Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID];
                                        Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID] = null;
                                        State = 0;
                                        Program.UsingButton = null;
                        ...
                        switch ((ItemType)Program.Data.MyItems[Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID].ID].Type)
                        {
                            ...
                            case ItemType.Storage:
                                if (x >= X + 103 && x <= X + 135 && y >= Y + 163 && y <= Y + 195)
                                {
                                    ...
                                    else if ((ItemType)Program.Data.MyItems[Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Equipment[10].ID].Type == ItemType.Storage)
                                    {
                        ...
                        for (int c = 0; c < 4; c++)
                        {
                            if (x >= Program.State[1].GameGUI[5].X + (c * 38) + 6 && x <= Program.State[1].GameGUI[5].X + 38 * (c + 1) && y >= Program.State[1].GameGUI[5].Y + 26 + (r * 38) && y <= Program.State[1].GameGUI[5].Y + (r + 1) * 38 + 26)
                            {
                                ...
                                if (r * 4 + c + g.ScrollCount * 4 < Program.MyMap.Drop[g.DropY][g.DropX].Count)
                                {
                                    ...
                                    {
                                        Program.MyMap.Drop[g.DropY][g.DropX][r * 4 + c + g.ScrollCount] = Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID];
                                        Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID] = null;
                                        State = 0;
                                        Program.UsingButton = null;
                                        Program.MouseState = (int)MouseStateType.Normal;
                                ...
                                {
                                    Program.MyMap.Drop[g.DropY][g.DropX].Add(Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID]);
                                    Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID] = null;
                                    State = 0;
                                    Program.UsingButton = null;
                                    Program.MouseState = (int)MouseStateType.Normal;
        ...
        public void Draw()
        {
            ...
            {
                if (State == 0)
                    Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID].DrawSprite(_screen, X, Y);
                else
                    Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID].DrawSprite(_screen, Mouse.GetPosition(_screen).X - (int)Program.Data.SpriteBasedOnType(SpriteType.Items)[Program.Data.MyItems[Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID].ID].Sprite].Size.X / 2, Mouse.GetPosition(_screen).Y - (int)Program.Data.SpriteBasedOnType(SpriteType.Items)[Program.Data.MyItems[Program.Data.MyPlayerData[Program.CurrentSaveData].MainParty.MyParty[0].Inventory[SlotID].ID].Sprite].Size.Y / 2);
            }
        }
        public void Update()
        {
