...
namespace Lost_Soul
{
    public class InGameGUI : GUI
    {
        ...
        public InGameGUI(RenderWindow rw, int id)
        {
            ...
            X = 660;
            Y = 720;
            MyButton.Add(new InventoryButton(_screen, 5, X + 7, 720));
            MyButton.Add(new EquipmentButton(_screen, 6, X + 87, 720));
            MyButton.Add(new ActionButton(_screen, 43, X + 127, 720)); 
            Visibility = true;
        }
