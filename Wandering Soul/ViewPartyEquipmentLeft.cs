    ...
    public class ViewPartyEquipmentLeft : GUIButton
    {
        ...
        public void Draw()
        {
            ...
            if (g.SelectedParty > -1 && g.SelectedParty < Program.Data.MyPlayerDatas.Count && Program.Data.MyPlayerDatas[g.SelectedParty] != null)
            {
                ...
                {
                    if (Program.Data.MyPlayerDatas[g.SelectedParty].MainParty.MyParty[SlotID].Equipment[11] != null)
                    {
                        s.Texture = Program.Data.SpriteBasedOnType(SpriteType.Items)[Program.Data.MyPlayerDatas[SlotID].MainParty.MyParty[SlotID].Equipment[11].ID];
                        s.Position = new Vector2f(X, Y);
                        _screen.Draw(s);
                    }
                }
