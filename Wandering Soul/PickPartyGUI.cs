...
namespace Lost_Soul
{
    public class PickPartyGUI : GUI
    {
        RenderWindow _screen;
        public PickPartyGUI(RenderWindow rw, int id)
        {
            ...
            MyButton.Add(new PickPartySelection(_screen, 75, X + 8, Y + 41, 87));
            MyButton.Add(new PickMorePartyUp(_screen, 72, X + 153, Y + 41));
            MyButton.Add(new PickMorePartyDownButton(_screen, 71, X + 153, Y + 205));
            MyButton.Add(new PickPartyMoreBar(_screen, 70, X + 153, Y + 60));
            MyButton.Add(new PickPartyLoading(_screen, 74, X + 8, Y + 228));
            MyButton.Add(new PickPartyNewParty(_screen, 73, X + 114, Y + 228));
            MyButton.Add(new PickPartyPickButton(_screen, 79, X + 83, Y + 228));
            MyButton.Add(new PickPartyDeleteButton(_screen, 78, X + 145, Y + 228));
            MyButton.Add(new PickPartyBackButton(_screen, 20, X + 156, Y + 4));
            CurrentButton = 0;
            Visibility = false;
        }
