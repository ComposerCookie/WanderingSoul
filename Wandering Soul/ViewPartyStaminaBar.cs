        ...
        public void Draw()
        {
            ...
            if (g.SelectedParty > -1 && g.SelectedParty < Program.Data.MyPlayerDatas.Count && Program.Data.MyPlayerDatas[g.SelectedParty] != null)
            {
                if (SlotID < Program.Data.MyPlayerDatas[g.SelectedParty].MainParty.MyParty.Count)
                {
                    ...
                    s.TextureRect = new IntRect(0, 0, Program.Data.MyPlayerDatas[g.SelectedParty].MainParty.MyParty[SlotID].CurrentStamina * 100 / Program.Data.MyPlayerDatas[g.SelectedParty].MainParty.MyParty[SlotID].MaxStamina * (int)s.Texture.Size.X / 100, (int)s.Texture.Size.Y);
                    _screen.Draw(s);
                }
            }
        }
