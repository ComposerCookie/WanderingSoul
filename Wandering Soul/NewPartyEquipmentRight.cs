    ...
    public class NewPartyEquipmentRight : GUIButton
    {
        ...
        public void Draw()
        {
            ...
            if (g.CurrentSession != null)
            {
                ...
                {
                    if (g.CurrentSession.MainParty.MyParty[SlotID].Equipment.Weapon1 != null)
                    {
                        s.Texture = Program.Data.SpriteBasedOnType(SpriteType.Items)[Program.Data.MyPlayerDatas[SlotID].MainParty.MyParty[SlotID].Equipment.Weapon1.ID];
                        s.Position = new Vector2f(X, Y);
                        _screen.Draw(s);
                    }
                }
