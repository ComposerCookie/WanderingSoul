    ...
    public class EquipmentSlot : GUIButton
    {
        ...
        public void Picked()
        {
            if (Mouse.IsButtonPressed(Mouse.Button.Left))
            {
                if (State == 0)
                {
                    if (Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID] == null)
                    {
                        return;
                    }
                    State = 1;
            ...
            if (State == 1 && Program.UsingButton != null)
            {
                        ...
                        for (int r = 0; r < 4; r++)
                        {
                            for (int c = 0; c < 4; c++)
                            {
                                ...
                                if (x >= Program.SM.States[1].GameGUI[1].X + (c * 38) + 6 && x <= Program.SM.States[1].GameGUI[1].X + 38 * (c + 1) && y >= Program.SM.States[1].GameGUI[1].Y + 26 + (r * 38) && y <= Program.SM.States[1].GameGUI[1].Y + (r + 1) * 38 + 26)
                                {
                                    ...
                                    {
                                        Program.Data.CurrentParty.MainParty.MyParty[0].UnequipItems(SlotID, r * 4 + c);
                                        State = 0;
                                    ...
                                    else
                                    {
                                        ...
                                        if (temp.ID == Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].ID && Program.Data.MyItems[temp.ID].Stackable)
                                        {
                                            temp.Amount += Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].Amount;
                                            Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID] = null;
                                        }
                                        else
                                        {
                                            Program.Data.CurrentParty.MainParty.MyParty[0].UnequipItems(SlotID, r * 4 + c);
                                            Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID] = temp;
                                            return;
                                        }
                                    }
                                }
                ...
                else if (x >= Program.SM.States[1].GameGUI[2].X && x <= Program.SM.States[1].GameGUI[2].X + 140 && y >= Program.SM.States[1].GameGUI[2].Y && y <= Program.SM.States[1].GameGUI[2].Y + 200)
                {
                    if (Program.SM.States[1].GameGUI[2].Visibility)
                    {
                        ...
                        switch ((ItemType)Program.Data.MyItems[Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].ID].Type)
                        {
                            case ItemType.Weapon:
                                if (x >= Program.SM.States[1].GameGUI[2].X + 33 && x <= Program.SM.States[1].GameGUI[2].X + 65 && y >= Program.SM.States[1].GameGUI[2].Y + 95 && y <= Program.SM.States[1].GameGUI[2].Y + 127)
                                {
                                    ...
                                    else if (Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[11] == null)
                                    {
                                        Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[11] = Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID];
                                        Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID] = null;
                                        State = 0;
                                        Program.UsingButton = null;
                                        Program.MouseState = (int)MouseStateType.Normal;
                                ...
                                else if (x >= Program.SM.States[1].GameGUI[2].X + 104 && x <= Program.SM.States[1].GameGUI[2].X + 136 && y >= Program.SM.States[1].GameGUI[2].Y + 95 && y <= Program.SM.States[1].GameGUI[2].Y + 127)
                                {
                                    ...
                                    else if (Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[7] == null)
                                    {
                                        Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[7] = Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID];
                                        Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID] = null;
                                        State = 0;
                                        Program.UsingButton = null;
                                        Program.MouseState = (int)MouseStateType.Normal;
                            ...
                            case ItemType.Ring:
                                if (x >= Program.SM.States[1].GameGUI[2].X + 5 && x <= Program.SM.States[1].GameGUI[2].X + 37 && y >= Program.SM.States[1].GameGUI[2].Y + 128 && y <= Program.SM.States[1].GameGUI[2].Y + 160)
                                {
                                    ...
                                    else if (Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[10] == null)
                                    {
                                        Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[10] = Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID];
                                        Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID] = null;
                                        State = 0;
                                        Program.UsingButton = null;
                                        Program.MouseState = (int)MouseStateType.Normal;
                        ...
                        for (int c = 0; c < 4; c++)
                        {
                            if (x >= Program.SM.States[1].GameGUI[5].X + (c * 38) + 6 && x <= Program.SM.States[1].GameGUI[5].X + 38 * (c + 1) && y >= Program.SM.States[1].GameGUI[5].Y + 26 + (r * 38) && y <= Program.SM.States[1].GameGUI[5].Y + (r + 1) * 38 + 26)
                            {
                                ...
                                if (r * 4 + c + g.ScrollCount * 4 < Program.Data.CurrentParty.MainParty.MyParty[0].CurMap.Drop[g.DropY][g.DropX].Count)
                                {
                                    ...
                                    {
                                        Program.Data.CurrentParty.MainParty.MyParty[0].CurMap.Drop[g.DropY][g.DropX][r * 4 + c + g.ScrollCount] = Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID];
                                        Program.Data.CurrentParty.MainParty.MyParty[0].UnequipItems(SlotID);
                                        State = 0;
                                        Program.UsingButton = null;
                                        Program.MouseState = (int)MouseStateType.Normal;
                                        return;
                                ...
                                {
                                    Program.Data.CurrentParty.MainParty.MyParty[0].CurMap.Drop[g.DropY][g.DropX].Add(Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID]);
                                    Program.Data.CurrentParty.MainParty.MyParty[0].UnequipItems(SlotID);
                                    State = 0;
                                    Program.UsingButton = null;
                                    Program.MouseState = (int)MouseStateType.Normal;
                                 ...
                                 * */
                                Program.Data.CurrentParty.MainParty.MyParty[0].DropItemFromEquipment(SlotID);
                                State = 0;
                                Program.UsingButton = null;
                                Program.MouseState = (int)MouseStateType.Normal;
                            }
                    ...
                    if (Program.Data.CurrentParty.MainParty.MyParty[0].CurMap.SpawnedSpawnableLocation[gc.LocY][gc.LocX] > -1)
                    {
                        ...
                        for (int r = 0; r < 3; r++)
                        {
                            if (r + gc.CurPage < b.Required.Count)
                            {
                                ...
                                {
                                    if (Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].ID == b.Required.ElementAt(r + 3 * gc.CurPage).Key.ID)
                                    {
                                        ...
                                        {
                                            if (Program.Data.MyItems[Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].ID].Stackable)
                                            {
                                                b.Required.ElementAt(r + 3 * gc.CurPage).Value.Add(new SpawnItems(Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].ID));
                                                Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].Amount--;
                                                if (Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].Amount <= 0)
                                                {
                                                    Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID] = null;
                                                    State = 0;
                                                    Program.UsingButton = null;
                                            ...
                                            {
                                                b.Required.ElementAt(r + 3 * gc.CurPage).Value.Add(Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID]);
                                                Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID] = null;
                                                State = 0;
                                                Program.UsingButton = null;
                                                Program.MouseState = (int)MouseStateType.Normal;
        ...
        public void Draw()
        {
            ...
            {
                if (State == 0)
                    Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].DrawSprite(_screen, X, Y);
                else
                {
                    Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].DrawSprite(_screen, Mouse.GetPosition(_screen).X - (int)Program.Data.SpriteBasedOnType(SpriteType.Items)[Program.Data.MyItems[Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].ID].Sprite].Size.X / 2, Mouse.GetPosition(_screen).Y - (int)Program.Data.SpriteBasedOnType(SpriteType.Items)[Program.Data.MyItems[Program.Data.CurrentParty.MainParty.MyParty[0].Equipment[SlotID].ID].Sprite].Size.Y / 2);
                }
            }
        }
        public void Update()
