...
namespace Lost_Soul
{
    public class EquipmentGUI : GUI
    {
        ...
        public EquipmentGUI(RenderWindow rw, int id)
        {
            ...
            MyButton.Add(new EquipmentSlot(_screen, 9, X + 104, Y + 25, 0));
            MyButton.Add(new EquipmentSlot(_screen, 10, X + 68, Y + 89, 1));
            MyButton.Add(new EquipmentSlot(_screen, 11, X + 69, Y + 132, 2));
            MyButton.Add(new EquipmentSlot(_screen, 12, X + 6, Y + 62, 3));
            MyButton.Add(new EquipmentSlot(_screen, 13, X + 104, Y + 60, 4));
            MyButton.Add(new EquipmentSlot(_screen, 14, X + 68, Y + 46, 5));
            MyButton.Add(new EquipmentSlot(_screen, 15, X + 6, Y + 26, 6));
            MyButton.Add(new EquipmentSlot(_screen, 16, X + 104, Y + 95, 7));
            MyButton.Add(new EquipmentSlot(_screen, 17, X + 5, Y + 128, 8));
            MyButton.Add(new EquipmentSlot(_screen, 17, X + 5, Y + 163, 9));
            MyButton.Add(new EquipmentSlot(_screen, 18, X + 103, Y + 163, 10));
            MyButton.Add(new EquipmentSlot(_screen, 19, X + 33, Y + 95, 11));
