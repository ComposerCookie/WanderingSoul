    ...
    public class HUDHealthBar : GUIButton
    {
        ...
        public void Draw()
        {
            ...
            for (int p = 0; p < Program.Data.CurrentParty.MainParty.MyParty.Count; p++)
            {
                ...
                s.TextureRect = new IntRect(0, 0, Program.Data.CurrentParty.MainParty.MyParty[p].CurHP * 100  / Logic.GetMaxHealthBasedOnStat(Program.Data.CurrentParty.MainParty.MyParty[p]) * (int)s.Texture.Size.X / 100, (int)s.Texture.Size.Y);
