...
namespace Lost_Soul
{
    public class RightClickLitFireButton : RightClickButton
    {
        RenderWindow _screen;

        public RightClickLitFireButton(RenderWindow rw, int id, int x, int y, int locx, int locy)
        {
            _screen = rw;
            ID = id;
            X = x;
        ...
        public void Draw()
        {
            if (Visibility)
            {
                ...
                Text t = new Text("Lit", Program.Data.Font, 10);
        ...
        public void Picked()
        {
            if (Mouse.IsButtonPressed(Mouse.Button.Left))
            {
                ...
                Program.Data.CurrentParty.MainParty.MyParty[0].CurrentAction = 4;
