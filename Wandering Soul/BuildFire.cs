...
namespace Lost_Soul
{
    public class BuildFire : Buildable
    {
        ...
        public List<int> LittedSpriteAnim { get; set; }
        ...
        public BuildFire(string name, int maxhealth, int sizex, int sizey, int sprite, int startsprite, int stage1, int stage2, int destroysprite, byte blocked, List<int> classific, Dictionary<SpawnItems, int> requried, List<SpawnItems> drop, int tick, List<int> buildontype, List<int> litanim, int firespeed)
        {
            Name = name;
            MaxHealth = maxhealth;
            SizeX = sizex;
            ...
            DestroyDrop = drop;
            Tick = tick;
            BuildableOnType = buildontype;
            LittedSpriteAnim = litanim;
            FireSpeed = firespeed;
        }
    }
}
